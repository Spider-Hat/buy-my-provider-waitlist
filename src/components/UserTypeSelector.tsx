      ...
      <button
        ...
        className={cn(
          ...
          selectedType === "buyer"
            ...
            : "border-brand-cultured bg-brand-cultured/60"
        )}
      >
        <div className="flex flex-col items-center text-center space-y-4">
          <div className={cn(
            ...
            selectedType === "buyer"
              ...
              : "bg-brand-cultured text-brand-cerulean"
          )}>
        ...
        {selectedType === "buyer" && (
          <div className="absolute top-4 right-4 w-6 h-6 rounded-full bg-brand-lime text-brand-eerie flex items-center justify-center animate-scale-in">
